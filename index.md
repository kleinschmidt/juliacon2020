...
```
LinReg: n=100 | value=[0.998611, 1.9986, 3.00469]
```
...
```
(y = 4.048027796549939, a = 0.23080319568124286, b = 0.8621071386146058)
```
...
```
ex-Formulated: n=100 | value=((Intercept) = 0.999778, a = 1.99701, b = 3.00391)
```
...
```
(y = 1.7710468287831478, a = 0.38486683931438237, b = "argle")
```
...
```
ex-Formulated: n=100 | value=((Intercept) = 0.99809, a = 1.99908, b: bargle = 3.00007)
```
...
```
(y = 2.9803054813513845, a = 0.99833508690532, b = "argle")
```
...
```
ex-Formulated: n=100 | value=((Intercept) = 1.00425, a = 1.99095, b: bargle = 2.99798, a & b: bargle = 4.00614)
```
...
```
(y = 4.873407792367286, a = 0.28569189111575777, b = "argle")
```
...
```
ex-Formulated: n=100 | value=((Intercept) = 1.00087, a = 1.99978, b: bargle = 3.00034, a & b: bargle = 4.00047)
```
...
10×4 Array{Float64,2}:
 1.0  0.295934  0.0  0.0
 1.0  0.327628  1.0  0.327628
 1.0  0.625538  0.0  0.0
 1.0  0.906559  1.0  0.906559
 1.0  0.349126  0.0  0.0
 1.0  0.436085  1.0  0.436085
 1.0  0.555425  0.0  0.0
 1.0  0.817652  1.0  0.817652
 1.0  0.106296  0.0  0.0
 1.0  0.519408  1.0  0.519408
```
